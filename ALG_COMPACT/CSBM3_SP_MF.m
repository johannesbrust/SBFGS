%%%%%%% CSBM3_SP (compact-structured-BFGS Minus Version 3 Sparse %%%%%%%%%%
%                   Matrix free)                                 %%%%%%%%%%
%
...
function [bool_conv,sol] = CSBM3_SP_MF(prob,par,func)
...
CSB         = par.initB0 * spIn + sparse(func.getHessFull(iter.x,par));
% Initial matrix (Psi0)
%CSB         = Psi0;
