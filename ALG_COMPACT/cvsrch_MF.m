      function [x,f,g,alp_trial,info,nfev,stx,sty] ...
       = cvsrch_MF(fcn,n,x,f,g,p,alp_trial,c1,c2,xtol, ...
...
%
%     **********
% 10/16/19, J.B., modification for matrix-free method
...
%             end
            ...
            % Requires: func.Hessprod(x,sk)
            bk = yk + func.getHessProd(x,sk,par);
            %bk = yk + Hkplus*sk;
