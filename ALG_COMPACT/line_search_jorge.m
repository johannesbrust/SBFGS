...
function [ret,newIter,newStep,newProb,num_LS,use_zoom,par] = line_search_jorge(iter,step,prob,par_in,func)
...
maxfev	= 3000;
nfev    = 0;
[xWol,fWol,gWol,alp_Wol,info,nfev, stx, sty] = cvsrch(@fcn,n,x,f0,g0,p,alp_init,c1,c2,xtol,stpmin,stpmax,maxfev,prob,par,func);
...
%     fprintf('stx %g   sty %g\n', stx,sty);
    [xWol,fWol,gWol,alp_Wol,info,nfev,stx,sty] = cvsrch(@fcn,n,x,f0,g0,p,alp_init,c1,c2,xtol,stpmin,4000,maxfev,prob,par,func);
    findwolfe=1;
    if info==7
