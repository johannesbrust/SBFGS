...
% 
function [ret,wolfeProb,par, couldnotfindtildealpha] = modify_WolfeStep_MF(currIter,currProb,wolfe_iter,wolfe_step,wolfe_prob,par_in,func, stx,sty)
...
%  end 
 ...
 %bk = yk + Hes_kplus1*sk;
 %bk = yk + Hes_kplus1*sk;
 Hs = func.getHessProd(wolfeIter.x,sk,par);
 bk = yk + Hs;
