...
% (1) Line-search trust-region
% (2) Dense B_0, lambda=1/2, Formula
% (3) Dense B_0, lambda=1 (Original dense)
...
paramsC = params; paramsC.c = 1; paramsC.lamc = 1/2; % scaling of \gamma^{\perp}
...
save('ResultsEXPERIMENT_VI_i_10','ex','numit','t_aver','numf','numg','params','tract');
