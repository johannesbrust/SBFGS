...
while ischar(tline)     
	...
	[ex(p,s),numf(p,s),numg(p,s),numit(p,s),tcpu(s,:,p),tract(p,s)]=...
        ...
        s=s+1;         
        [ex(p,s),numf(p,s),numg(p,s),numit(p,s),tcpu(s,:,p),tract(p,s)]=...
            runAlgorithm(@LMTR_EIG_inf_2_DENSE_G10_F_TERM_C_L,x0,paramsC,numRuns);
...
save('ResultsEXPERIMENT_V_i_10','ex','numit','t_aver','numf','numg','params','tract');
