function [varargout] = cutest_fun_STRU_AL( x, varargin )
%---- unconstrained structured augmented Lagrangian objective ------------%
%
% cutest_fun_STRU_AL.m is a function to compute the Augmented Lagrangian to 
% interface with the structured SLMTR_DENSE_B0 solver.
%
...
% variable MU_AL. 
%
% This function computes the 'unknown gradient' (grad(c'c)) in addition 
