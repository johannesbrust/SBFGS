...
leg={  '$\hat{\mathbf{B}}_0(\gamma_k,\hat{\gamma}^{\perp}_k, \lambda = 1/2)^*$',...
       '$\hat{\mathbf{B}}_0(\gamma_k,\gamma^{\perp}_k)$'};
...
leg={  '$\hat{\mathbf{B}}_0(\gamma_k,\hat{\gamma}^{\perp}_k, \lambda = 1/2)^*$',...
       '$\hat{\mathbf{B}}_0(\gamma_k,\hat{\gamma}^{\perp}_k, \lambda = 1/2)^*$-SVDI',...
       '$\hat{\mathbf{B}}_0(\gamma_k,\hat{\gamma}^{\perp}_k, \lambda = 1/2)^*$-SVDII'};
