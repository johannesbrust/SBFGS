function [x,f,outinfo] = LMTR_EIG_inf_2_DENSE_G10_F_C(fun,x0,params)
% LMTR_EIG_inf_2_DENSE_G10_F_C - limited memory trust-region algorithm EIG(inf,2) with
% formula for computing the unconstrained minimizer with a dense initial
% matrix. Allows for scaling factors c.
%
% For details, see: 
...
here we use:
    ...
    gamma_perp = max_i gamma_i,  gamma = y'y/s'y.

J.B 06/27/17
Allowance of additional scaling for the parameter gamma_perp, i.e:
