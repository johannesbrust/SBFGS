function [x,f,outinfo] = LMTR_EIG_inf_2_DENSE_G6(fun,x0,params)
...
is rejected. The L-BFGS matrix has form
    ...
    gamma_perp =  s1'y / s1's, s1 = P_perp P_perp' g.
...
%        gp = delta;
        ...
        RU(1:rankV,1:rankV) = R(1:rankV,maskldl)\U(1:rankV,1:rankV);        
