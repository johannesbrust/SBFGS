function [x,f,outinfo] = LMTR_INTF1(fun,grad,x0,params)
% LMTR_INTF1 - limited memory trust-region algorithm EIG(inf,2). 
%
...
%}
% 10/04/19, J.B., modified interface for inclusion separate gradient calls.
% 10/23/19, J.B., removal of dense initialization (for comparisons)
