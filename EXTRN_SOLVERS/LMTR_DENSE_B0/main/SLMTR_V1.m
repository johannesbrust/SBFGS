function [x,f,outinfo] = SLMTR_V1(fun,hprod,x0,params)
%- SLMTR_V1 (Structured-limited-memory trust-region method, Version 1) ---%
%
...
%
% This version (Version 1) modifies the computation of yk. For parameter
% \theta \in [0,1]:
% 
...
if ngi>gtol  % norm of gradient is too large    ng>gtol*max(1,norm(x))
    ...
    % y = g-g_old;
    % Compute Hessian product only if desired
    if theta == 0
        y= (g-g_old);
    else
