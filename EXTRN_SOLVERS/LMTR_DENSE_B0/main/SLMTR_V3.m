function [x,f,outinfo] = SLMTR_V3(fun,hprod,x0,params)
%- SLMTR_V3 (Structured-limited-memory trust-region method, Version 3) ---%
%
...
%
% This version (Version 3) modifies the computation of yk. For parameter
% \theta \in [0,1]:
% 
% yk = (g_{k+1} - gk) + \theta.( K_{k+1}sk + (u'_{k+1} - u'_k) - (g_{k+1} -
% gk) ).
% This version only does the structured updates if ||s|| < threshold, and
% it takes a full structured step in this case (not a scaled structured).
%
