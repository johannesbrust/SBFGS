function [x,f,outinfo] = SLMTR_V4(fun,hprod,x0,params)
%----- SLMTR_V4 (Structured-limited-memory trust-region method V4) -------%
%
% V4 implements the structured secant approximation described in ``Convergence
% Theory for the Structured BFGS Secant Method with an Application to
% Nonlinear Least Squares", Dennis, Martinez, Tapia, 1989.
%
...
%
% INPUTS:
% fun: Structured objective (4 calling patterns)
%       [f]             = fun(x);
%       [f,gk]          = fun(x);
%       [f,gk,gu,gv4]   = fun(x,s);
%       [gk,gu,gv4]     = fun(x,s,'grad');
