...
% Forming Q matrices
q1o     = q1_orthog(n,r,laml,lamu);
q2o     = q1_orthog(n,r,laml2,lamu2);
...
for j = 1:nsel
    ...
    out6         = EX_IPOPT_F(prob,fncIP,optsIP);
    
    out7         = EX_LBFGSB_F(prob,fncLB,optsLB);
    
    out8         = EX_SOLVENLP_F(prob,fncSB,parSBFGS);
